...
const animateElements = document.querySelectorAll('.project-card, .timeline-item, .skill-category, .experience-item, .honor-item, .publication-item, .language-item, .service-item, .thesis-card');
